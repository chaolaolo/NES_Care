...
const SignUpScreen = () => {
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <View>
                <TextInputComponent placeholder="Full name" tipStyle={{ height: 70, paddingLeft: 60 }} />
            ...
            <View>
                <TextInputComponent placeholder="Re-Enter Password" tipStyle={{ height: 70, paddingLeft: 60 }} secureTextEntry={!isRePasswordVisible} />
                <Image source={require('./image/ic_LeftinputPass.png')} style={styles.imgEmail} />
                <TouchableOpacity
