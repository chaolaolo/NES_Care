...
function CustomDrawerContent(props: any) {
  ...
  return (
    <DrawerContentScrollView {...props}>
      ...
      <TouchableOpacity style={{ flexDirection: 'row', borderWidth: 1,borderRadius:10, paddingVertical: 16, alignItems: 'center', justifyContent: 'space-around',marginHorizontal:40,alignSelf:'flex-end'}}>
        <Text>Sign Out</Text>
