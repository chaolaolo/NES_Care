        ...
        <SafeAreaView style={styles.container}>
            ...
            <ScrollView style={{ backgroundColor: '#EDECF4', width: '100%', marginTop: 78, borderTopLeftRadius: 20, borderTopRightRadius: 20 }}>
                ...
                <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
                    <Text onPress={() => navigation.navigate('CalculateBMIScreen')} style={{ fontSize: 16, color: '#5198FF', textDecorationLine: 'underline' }}>Tham khảo kiến thức về dinh dưỡng</Text>
                </View>
            </ScrollView>
        </SafeAreaView>
    )
