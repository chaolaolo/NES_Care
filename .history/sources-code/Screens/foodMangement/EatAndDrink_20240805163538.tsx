    ...
    return (
        <SafeAreaView style={styles.container}>
            <HeaderComponent title="Eats and Drinks" style={styles.headerContainer}>
                ...
                <Text style={styles.headerTitle}>Gợi ý ăn uống</Text>
            </HeaderComponent>
            <ScrollView style={{ backgroundColor: '#EDECF4', width: '100%', marginTop: 78, borderTopLeftRadius: 20, borderTopRightRadius: 20 }}>
                ...
                <BlockComponent>
                    <Text style={styles.title}>Gợi ý tập luyện</Text>
                ...
                <View style={{ marginVertical: 20 }}>
                    <Text style={{ color: '#432C81', fontSize: 18, marginHorizontal: 20 }}>BMI hiện tại: {user.bmi}</Text>
                    <Text style={{ color: '#432C81', fontSize: 18, marginHorizontal: 20 }}>Trạng thái: {user.BMIstatus}</Text>
                    <ButtonComponent title='CẬP NHẬT BMI' onPress={() => navigation.navigate('CalculateBMIScreen')} />
                </View>
