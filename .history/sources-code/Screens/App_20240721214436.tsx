...
function CustomDrawerContent(props: any) {
  ...
  return (
    <DrawerContentScrollView style={{backgroundColor:'red'}} {...props}>
      ...
      <TouchableOpacity style={{ flexDirection: 'row', borderWidth: 1,borderRadius:10, paddingVertical: 16, alignItems: 'center', justifyContent: 'space-around',marginHorizontal:40,position:'static',bottom:0 }}>
        <Text>Sign Out</Text>
