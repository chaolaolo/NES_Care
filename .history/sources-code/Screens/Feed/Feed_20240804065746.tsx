...
const Feed = () => {
  ...
  return (
    <SafeAreaView style={styles.container}>
      {isLoading ? (
        <View style={{ position: 'absolute', width: '120%', height: '100%', backgroundColor: 'rgba(0,0,0,0.2)', alignSelf: 'center', justifyContent: 'center', alignItems: 'center' }}>
        ...
        listGrateful.length > 0 ? (
          ...
          <Text style>No grateful posts found.</Text>
        )
