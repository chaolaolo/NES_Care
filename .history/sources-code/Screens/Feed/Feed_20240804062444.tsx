  ...
  const renderItem = ({ item }) => {
    return (
      <View style={styles.itemContainer}>
        ...
        <View style={{ backgroundColor: 'gray',flexDirection:'row',width:90,alignSelf:'flex-end' }}>
          <Image source={require('../../image/ic_delete_gratefull.png')} style={{ width: 40, height: 40 }} />
          <Image source={require('../../image/ic_delete_gratefull.png')} style={{ width: 40, height: 40 }} />
        </View>
      </View>
    );
