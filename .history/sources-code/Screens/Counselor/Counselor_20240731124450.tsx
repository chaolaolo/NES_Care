...
//         return (
//             <TouchableOpacity style={styles.itemContainer} onPress={() => navigation.navigate('ChatScreen', { fullName: item.fullName, avatar: item.avatar, uid: item.uid, chatId: chatId })}>
...
//                         //     item.role == "Expert" && (
//                         //         <>
//                         //             <Text style={{ marginLeft: 16 }}>(Chưa cập nhật)</Text>
//                         //         </>
//                         //     )
//                         // }
//                     }
        ...
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.contentContainer}>
                {listPerson.length > 0 ? (
                    ...
                    <Text style={styles.emptyListText}>Chưa có chuyên gia nào trong lĩnh vực này, vui lòng chọn lại sau!</Text>
                )}
            </View>
...
const styles = StyleSheet.create({
    ...
    contentContainer: {
        backgroundColor: 'rgba(237, 236, 244, 0.2)',
        flex: 1,
        borderTopLeftRadius: 20,
        borderTopRightRadius: 20,
        elevation: 2,
