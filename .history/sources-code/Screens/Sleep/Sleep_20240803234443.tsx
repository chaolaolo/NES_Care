  ...
  return (
    <SafeAreaView style={styles.container}>
        ...
        <BlockComponent style={{ backgroundColor: '#E4F9F3', }}>
          <Text style={{fontSize:20,fontWeight:'bold',color:''}}>Thiết lập</Text>
          <Text style={{fontSize:16,textAlign:'justify' ,color:''}}>Hãy thiết lập giờ ngủ của bạn để bạn có giâc giấc ngủ tốt hơn và để chúng tôi hiểu thói quen ngủ của bạn.</Text>
          <ButtonComponent
          title="THIẾT LẬP"
          >
