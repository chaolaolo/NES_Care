  ...
  const fetchLatestSleepSetting = async () => {
    try {
      ...
      if (!snapshot.empty) {
        ...
        setTimeStart(latestDoc.timeStart || '');
        setTimeStop(latestDoc.timeStop || '');
        setTimeSleeptarget(latestDoc.timeSleeptarget || 0);
        setCheckAlarm(latestDoc.checkAlarm || false);
      } else {
        // Set default values if no document is found
        setTimeStart(0);
        setTimeStop(0);
        setTimeSleeptarget(0);
        setCheckAlarm(false);
      }
    } catch (error) {
            ...
            <View style={{ marginTop: 40 }}>
              ...
              <View style={{
                ...
                <View style={{ flexDirection: 'row', alignItems: 'center', marginVertical: 10 }}>
                  ...
                  <Text style={{ color: '#5198FF', fontSize: 18, }}>{timeSleeptarget} giờ</Text>
                </View>
                <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                  <Image source={require('../../image/ic_lock.png')} style={{ width: 30, height: 30, marginRight: 10 }} />
                  <View style={{ flex: 1 }}>
                    <Text>Giờ đi ngủ</Text>
                    <Text style={{ color: 'rgba(67, 44, 129, 0.8)', fontSize: 16 }}>{timeStart}</Text>
                  </View>
                </View>
                <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                  <Image source={require('../../image/ic_lock.png')} style={{ width: 30, height: 30, marginRight: 10 }} />
                  <View style={{ flex: 1 }}>
                    ...
                    <Text style={{ color: 'rgba(67, 44, 129, 0.8)', fontSize: 16 }}>{timeStop}</Text>
                  </View>
                </View>
              </View>
            </View>
