    ...
    <DrawerContentScrollView {...props}>
      <View style={styles.boxHeader}>
        ...
        <View style={{flexDirection:'row'}}>
          ...
          <Text style={[styles.txtName,{color: '#432C81', fontWeight: 'bold',}]}>{user.fullName}</Text>
        </View>
      </View>
    ...
    >
      <Drawer.Screen
        ...
        options={{
          ...
          drawerIcon: (props) => (
            <Image source={require('../BottomTabIcon/ic_home.png')} style={{ width: 20, height: 20, marginRight: -10 }} />
          )
        }}
      />
      <Drawer.Screen
        ...
        options={{
          ...
          headerShadowVisible: false,
          drawerIcon: () => (
            <Image source={require('../BottomTabIcon/ic_docs.png')} style={{ width: 20, height: 20, marginRight: -10 }} />
          )
        }}
      />
      <Drawer.Screen
        ...
        options={{
          ...
          headerShadowVisible: false,
          drawerIcon: () => (
            <Image source={require('../BottomTabIcon/ic_notification.png')} style={{ width: 20, height: 20, marginRight: -10 }} />
          )
        }}
      />
      <Drawer.Screen
        ...
        options={{
          ...
          headerShadowVisible: false,
          drawerIcon: () => (
            <Image source={require('../BottomTabIcon/ic_profile.png')} style={{ width: 20, height: 20, marginRight: -10 }} />
          )
        }}
      />
