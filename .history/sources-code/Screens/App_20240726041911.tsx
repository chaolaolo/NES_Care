...
const MainStack = () => {
  return (
    <Stack.Navigator initialRouteName='PhysicalActivities' screenOptions={{ headerShown: false }}>
    ...
    >
      ...
      <Drawer.Screen
        ...
        options={{
          ...
          headerShadowVisible: false,
          drawerIcon: () => (
            <Image source={require('../HomeIcon/ic_ear.png')} style={{ width: 30, height: 30, marginRight: -10 }} />
          ),
        }}
      />
