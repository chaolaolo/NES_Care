    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <View style={{ flexDirection: 'row', justifyContent: 'space-between', }}>
                ...
                <Pressable
                    onPress={() => handleActivityChange('Tìm Bạn')}
                    style={{
                        flex: 1,
                        // backgroundColor: selectedActivity === 'Yoga' ? '#007bff' : '#ccc',
                        paddingVertical: 5,
                        ...
                        justifyContent: 'center',
                        borderColor: '#21CE9C',
                        backgroundColor: selectedActivity === 'Tìm Bạn' ? 'rgba(0,0,0,0.05)' : 'white',
                        borderBottomWidth: selectedActivity === 'Tìm Bạn' ? 1 : 0,
                    }}>
                    <Text style={{
                        color: selectedActivity === 'Tìm Bạn' ? '#21CE9C' : '#432C81',
                        fontWeight: selectedActivity === 'Tìm Bạn' ? 'bold' : 'normal',
                        fontSize: 16
                    }}>Tìm Bạn Mới</Text>
                </Pressable>
            </View>
            ...
            {selectedActivity === 'Tìm Bạn' && <AddFriends />}
        </SafeAreaView>
    )
}
