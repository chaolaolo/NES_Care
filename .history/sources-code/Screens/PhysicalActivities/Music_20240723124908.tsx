        ...
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.playingContainer}>
                ...
                <View style={{ flex: 1, marginHorizontal: 16 }}>
                    ...
                    <View style={{ width: 200, marginLeft: 40, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                        ...
                        <View style={{flexDirection:'row'}}>
                            ...
                            <Image style={{ width: 20, height: 20,marginLeft:10 }} source={require('../../image/ic_next_music.png')} />
                        </View>
                    </View>
                </View>
            </View>
