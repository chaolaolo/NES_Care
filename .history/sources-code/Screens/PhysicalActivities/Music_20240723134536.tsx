...
// import { playbackService, setupPlayer } from '../../Music/MusicService';
...
import { playbackService, setupPlayer } from '../../Music/MusicService';
// import { setupPlayer, playbackService } from './path_to_your_track_player_file'; // Cập nhật đường dẫn
...
const Music = () => {
    ...
    const renderItem = ({ item }) => (
        <View style={styles.itemContainer}>
            ...
            <View>
                <TouchableOpacity onPress={() => playTrack(item.link)}>
                    <Image style={styles.playmusic} source={require('../../image/ic_stop_music.png')} />
                </TouchableOpacity>
            </View>
        </View>
