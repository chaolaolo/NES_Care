...
//             setCurrentTracksID(tracks[0].id);
            ...
            {loading ? (
                ...
                <View style={styles.playingContainer}>
                    ...
                    <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                        <TouchableOpacity onPress={handlePrevious}>
                            <Image style={styles.icPlayingPrevious} source={require('../../image/ic_previous_music.png')} />
                        </TouchableOpacity>
                        <TouchableOpacity onPress={handlePlay}>
                            <Image style={styles.icPlayingPlay} source={playerState === State.Playing ? require('../../image/ic_stop_music.png') : require('../../image/ic_playing_music.png')} />
                        </TouchableOpacity>
                        <TouchableOpacity onPress={handleNext}>
                            <Image style={styles.icPlayingNext} source={require('../../image/ic_next_music.png')} />
                        </TouchableOpacity>
                    </View>
                </View>
        </SafeAreaView>
