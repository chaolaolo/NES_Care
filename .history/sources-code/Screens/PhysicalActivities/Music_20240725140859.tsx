...
function Playlist() {
    ...
    function PlaylistItem({ index, title, artist, url_cover, isCurrent }) {
        ...
        async function handleItemPress() {
            ...
            if (currentTrackIndex === index && await TrackPlayer.getState() === State.Playing) {
            ...
            <TouchableOpacity onPress={handleItemPress} style={[styles.itemContainer, { backgroundColor: isCurrent ? '#666' : 'white', }]}>
                ...
                <View>
                    <TouchableOpacity onPress={handleItemPress}>
                        ...
                        <Image style={styles.playmusic} source={isPlaying ? require('../../image/ic_playing_music.png') : require('../../image/ic_stop_music.png')} />
                    </TouchableOpacity>
                </View>
            </TouchableOpacity>
    ...
    return (
        <View style={{
            ...
            <TouchableOpacity onPress={handlePlayPress}>
                ...
                <Image source={isPlaying ? require('../../image/ic_playing_music.png') : require('../../image/ic_stop_music.png')} />
            </TouchableOpacity>
...
function Header() {
    ...
    async function setTrackInfo() {
        ...
        if (track != null) {
            ...
            setInfo({ title: 'Unknown', artist: 'Unknown', artwork: 'default_image_url' });
        }
    }
