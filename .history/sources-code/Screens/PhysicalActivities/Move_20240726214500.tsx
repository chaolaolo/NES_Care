...
//         Click “Start” to start your journey with NES Care!</Text>
//       <ButtonComponent
//         title={isCounting ? "You're moving, press to Stop" : "Start"} onPress={startCounting} style={{ backgroundColor: isCounting ? 'red' : '#21CE9C', paddingVertical: 18, marginTop: 60 }} />
//     </SafeAreaView>
//   )
// }
