    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.playingContainer}>
                <Image style={styles.imgPlayingCover} source={{ uri: url_cover } || require('../../image/ic_x.png')} />
                <View style={{ flex: 1, marginHorizontal: 16 }}>
                    <Text style={styles.musicName}>{musicName ? "Unknow Name" : musicName}</Text>
                    <Text style={styles.musicArtist}>{musicArtist ? "Unknow Artist" : musicArtist}</Text>
