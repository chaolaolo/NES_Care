    ...
    return (
        <View style={{
            ...
            <TouchableOpacity onPress={() => TrackPlayer.skipToPrevious()}>
                <Image style={{width:30,height:30}} source={require('../../image/ic_previous_music.png')} />
            </TouchableOpacity>
            <TouchableOpacity onPress={handlePlayPress}>
                <Image style={{width:50,height:50}} source={isPlaying ? require('../../image/ic_playing_music.png') : require('../../image/ic_stop_music.png')} />
            </TouchableOpacity>
            <TouchableOpacity onPress={() => TrackPlayer.skipToNext()}>
                <Image style={{width:30,height:30}} source={require('../../image/ic_next_music.png')} />
            </TouchableOpacity>
        </View>
    );
}
