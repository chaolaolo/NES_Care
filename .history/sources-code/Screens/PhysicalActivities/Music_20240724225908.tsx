        ...
        <SafeAreaView style={styles.container}>
            ...
            {currentTrack && (
                <View style={styles.playingContainer}>
                    ...
                    <TouchableOpacity onPress={handlePrevious}>
                        <Image style={styles.playButton} source={require('../../image/ic_previous.png')} />
                    </TouchableOpacity>
                    <TouchableOpacity onPress={() => handlePlay(currentTrack)}>
                        <Image style={styles.playButton} source={isPlaying ? require('../../image/ic_pause.png') : require('../../image/ic_play.png')} />
                    </TouchableOpacity>
                    <TouchableOpacity onPress={handleNext}>
                        <Image style={styles.playButton} source={require('../../image/ic_next.png')} />
                    </TouchableOpacity>
                </View>
            )}
        </SafeAreaView>
