...
//                     </>
//                 ) : (
//                     <Text style={{ alignSelf: 'center', textAlignVertical: 'center', flex: 1, fontSize: 20 }}>No track playing</Text>
//                 )}
//             </View> */}
...
import firestore from '@react-native-firebase/firestore';
import Slider from '@react-native-community/slider';
import TrackPlayer, { State, usePlaybackState, useTrackPlayerEvents } from 'react-native-track-player';
import { setupPlayer } from '../../Music/MusicService';
...
const Music = () => {
    ...
    const renderItem = ({ item }) => (
        <View style={styles.itemContainer}>
            ...
            <View>
                <TouchableOpacity onPress={() => handlePlay(item)}>
                    <Image style={styles.playmusic} source={playerState == State.Playing && currentTrack?.id === item.key ? require('../../image/ic_stop_music.png') : require('../../image/ic_playing_music.png')} />
                </TouchableOpacity>
            </View>
        </View>
    );
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            {currentTrack && playerState === State.Playing && (
                <View style={styles.playingContainer}>
                    <Image style={styles.imgPlayingCover} source={{ uri: currentTrack.artwork }} />
                    <View style={{ flex: 1, marginHorizontal: 16 }}>
                        <Text style={styles.musicName}>{currentTrack.title}</Text>
