...
//                         </TouchableOpacity>
//                         <TouchableOpacity onPress={() => playerState === State.Playing ? TrackPlayer.pause() : TrackPlayer.play()}>
//                             <Image
...
const Music = () => {
    ...
    const handlePrevious = async () => {
        const currentTrackIndex = listMusic.findIndex(music => music.key === currentTrack.id);
    ...
    const renderItem = ({ item }) => (
        <TouchableOpacity onPress={() => handlePlay(item)} style={styles.itemContainer}>
            <View>
                <Image source={{ uri: item.url_cover }} style={styles.itemImage} />
            </View>
            <View style={{ flex: 1 }}>
                <Text style={styles.musicName}>{item.name}</Text>
                <Text style={styles.musicArtist}>{item.artist}</Text>
            ...
            <View>
                <TouchableOpacity onPress={() => handlePlay(item)}>
                    <Image
                        ...
                        source={playerState === State.Playing && currentTrack && currentTrack.id === item.key ? require('../../image/ic_stop_music.png') : require('../../image/ic_playing_music.png')}
                    />
                </TouchableOpacity>
            </View>
        </TouchableOpacity>
                ...
                <View style={styles.playingContainer}>
                    ...
                    <View style={styles.playerControl}>
                        ...
                        <TouchableOpacity onPress={() => handlePlay(currentTrack)}>
                            <Image source={playerState === State.Playing ? require('../../image/ic_stop_music.png') : require('../../image/ic_playing_music.png')} />
                        </TouchableOpacity>
...
const styles = StyleSheet.create({
    ...
    itemContainer: { flexDirection: 'row', padding: 10, borderBottomWidth: 1, borderBottomColor: '#ccc', alignItems: 'center' },
    itemImage: { width: 50, height: 50, marginRight: 10 },
    musicName: { fontWeight: 'bold', color: '#432C81' },
    musicArtist: { color: '#432C81' },
    playmusic: { width: 24, height: 24 },
    playingContainer: { flexDirection: 'row', padding: 15, borderTopWidth: 1, borderTopColor: '#ccc', alignItems: 'center' },
    imgPlayingCover: { width: 50, height: 50 },
    playerControl: { flexDirection: 'row', justifyContent: 'space-around', width: 100 }
});
