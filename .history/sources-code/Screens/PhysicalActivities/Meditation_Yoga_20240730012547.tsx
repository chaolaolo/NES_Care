  ...
  return (
    <SafeAreaView style={styles.container}>
      <BlockComponent
        ...
        style={{ marginTop: 20, marginBottom: 4, paddingVertical: 20 }}>
        <Text style={styles.txtTitle}>Xem Video trong lúc thiền - yoga</Text>
        {/* <Text style={styles.txtContent}>000</Text> */}
      </BlockComponent>
      <BlockComponent
        onPress={() => navigation.navigate('Music')}
        style={{ marginVertical: 10, paddingVertical: 20 }}>
        <Text style={styles.txtTitle}>Nghe nhạc trong lúc thiền - yoga</Text>
