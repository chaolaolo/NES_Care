...
function Playlist({ category, searchQuery, setSearchQuery }) {
    ...
    const filteredQueue = filterTracks(queue, searchQuery);
...
function Header() {
    ...
    async function setTrackInfo() {
        ...
        if (track != null) {
            ...
            // setInfo(info);
            setInfo(trackInfo || { title: 'Unknown', artist: 'Unknown', artwork: 'https://media1.giphy.com/media/eJYIGMu4UuQlUiXfDC/giphy.gif?cid=6c09b9527pa43ls5qew4l6ftcdgmyd3jcofcixf9gkopft8q&ep=v1_internal_gif_by_id&rid=giphy.gif&ct=s' });
    ...
    return (
        <View style={{ marginRight: 10, flexDirection: 'row', flex: 1 }}>
            <Image source={info.artwork && info.artwork !== null ? { uri: info.artwork } : require('../../image/ic_sound.png')} style={styles.imgPlayingCover} />
    ...
    return (
        <MusicProvider>
            <SafeAreaView style={styles.container}>
                ...
                {play ? (<Playlist category={SelectedMusicSection} searchQuery={searchQuery} setSearchQuery={setSearchQuery} />)
                    :
                    (
