            ...
            <TouchableOpacity onPress={handleItemPress} style={[styles.itemContainer, { backgroundColor: isCurrent ? '#666' : 'white', }]}>
                ...
                <View>
                    <TouchableOpacity onPress={handleItemPress}>
                        ...
                        <Image style={styles.playmusic} source={isPlaying && TrackPlayer.getState() === State.Playing && currentTrack === index ? require('../../image/ic_playing_music.png') : require('../../image/ic_stop_music.png')} />
                    </TouchableOpacity>
                </View>
            </TouchableOpacity>
