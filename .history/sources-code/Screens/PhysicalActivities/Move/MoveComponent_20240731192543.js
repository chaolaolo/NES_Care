      ...
      <ScrollView>
        ...
        <View style={{ backgroundColor: '#E4F9F3', padding: 10, margin: 10 }}>
          <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
            ...
            <Text style={{ fontSize: 16, fontWeight: 'bold', color: '#7B6BA8' }}>{stepsTarget}/{latestTarget.stepsTarget || 'chưa đặt mục tiêu'}</Text>
          </View>
          <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
            <Text style={{ fontSize: 16 }}>Mục tiêu quãng đường:</Text>
            <Text style={{ fontSize: 16, fontWeight: 'bold', color: '#7B6BA8' }}>{latestTarget.distanceTarget || 'chưa đặt mục tiêu'}</Text>
          </View>
          <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
