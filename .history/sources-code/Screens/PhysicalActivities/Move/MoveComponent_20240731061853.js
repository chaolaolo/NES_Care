...
const MoveComponent = memo(({ steps, distance, movingTime, calories, isCounting, startCounting, resetCounting }) => {
  ...
  return (
    <View style={styles.container}>
      ...
      >
        <TextInputComponent placeholder={'Mục tiêu về số bước chân...'} />
        <TextInputComponent placeholder={'Mục tiêu về số quãng đường...'} />
        <TextInputComponent placeholder={'Mục tiêu về Thời gian...'} />
      </ModalComponent>
      {/* ***** */}
    </View>
  )
