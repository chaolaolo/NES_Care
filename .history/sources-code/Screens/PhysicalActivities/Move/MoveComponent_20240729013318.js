  ...
  return (
    <View style={styles.container}>
      ...
      <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'center', marginTop: 60 }}>
        ...
        /> */}
        <TouchableOpacity onPress={resetCounting} style={{ backgroundColor: 'gray', paddingVertical: 18, paddingHorizontal: 20 }}>
          <Image source={require('../../../image/ic_play_again.png')} style={{width:40,height:40}}/>
        </TouchableOpacity>
      </View>
    </View>
  )
