...
const MoveComponent = memo(({ steps, distance, movingTime, isCounting, startCounting, resetCounting }) => {
    ...
    <View style={styles.container}>
      ...
      <View style={{ flexDirection: 'row', }}>
        <ButtonComponent
          ...
          style={{ flex: 1, backgroundColor: isCounting ? 'red' : '#21CE9C', paddingVertical: 18, marginTop: 60 }}
        />
        {/* <ButtonComponent
          title="Reset"
        ...
        /> */}
        <TouchableOpacity onPress={resetCounting} style={{ backgroundColor: 'gray', paddingVertical: 110, paddingHorizontal: 10 }}>
          <Image source={require('../../../image/ic_play_again.png')} />
        </TouchableOpacity>
      </View>
    </View>
  )
