        ...
        <SafeAreaView style={styles.container}>
            ...
            <BlockComponent style={{ marginTop: 40 }}>
                ...
                <View style={{ flexDirection: 'row' }}>
                    ...
                    <View style={{ marginLeft: 10, marginVertical: 2, flex: 1, alignItems: !user.role ? 'center' : 'flex-end' }}>
                        <Text>Giới tính</Text>
                    ...
                    {user.role === 'Expert' && (
                        <>
                            <View style={{ marginLeft: 10, marginVertical: 2, flex: 1 }}>
                                ...
                                <Text style={styles.mainText}>{user.consultingField || 'Not update yet'}</Text>
                            </View>
                        </>
                    )}
                </View>
