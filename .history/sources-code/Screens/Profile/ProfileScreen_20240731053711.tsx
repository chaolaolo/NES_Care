    ...
    return (
        <SafeAreaView style={styles.container}>
            <ScrollView>
                ...
                <View style={{ backgroundColor: 'white', width: '90%', position: 'absolute', margin: 20, marginTop: 180 }}>
                    ...
                    <View style={{ flexDirection: 'row', marginTop: 10,paddingHorizontal:10 }}>
                        <View style={{ marginHorizontal:4, marginVertical: 2, flex: 1, alignItems: 'center', backgroundColor: 'red' }}>
                            <Text style={styles.mainText}>{age}</Text>
                            <Text>Tuổi</Text>
                        </View>
                        <View style={{ marginHorizontal:4, marginVertical: 2, flex: 1, alignItems: 'center', backgroundColor: 'red' }}>
                        ...
                        {user.role === 'Expert' ? (
                            <>
                                <View style={{ marginHorizontal:4, marginVertical: 2, flex: 1, backgroundColor: 'red' }}>
                                    <Text style={[styles.mainText, { fontSize: 17 }]}>{user.consultingField || 'Not update yet'}</Text>
                                    <Text>Chuyên gia</Text>
                                </View>
                            </>
                    ...
                    <View style={{ flexDirection: 'row', marginTop: 10,paddingHorizontal:10,backgroundColor:'red' }}>
                        <View style={{ marginHorizontal:4, marginVertical: 2, flex: 1, alignItems: 'center' }}>
                            <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                                <Text style={styles.mainText}>{user.height || 'Not Specified'}</Text>
                                <Text>(cm)</Text>
                            </View>
