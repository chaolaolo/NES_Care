    ...
    return (
        <SafeAreaView style={styles.container}>
            <ScrollView>
                ...
                <View style={{ backgroundColor: 'white', width: '90%', height: 20000, position: 'absolute', margin: 20, marginTop: 200 }}>
                    <View style={styles.mainContent}>
                        <TouchableOpacity onPress={() => setShowAvatar(true)} style={{ position: 'absolute', backgroundColor: 'red' }}>
                            <Image style={styles.imgAvatar} source={user.avatar ? { uri: user.avatar } : require('../../image/ic_LeftinputUserName.png')} />
                            <TouchableOpacity onPress={chooseAvatar} style={styles.boxicPen}>
                                <Image style={styles.icPen} source={require('../../image/ic_pen.png')} />
                            </TouchableOpacity>
                    ...
                    <View style={{marginTop:100, backgroundColor: 'gray' }}>
                        <Text style={{ color: '#432C81', fontWeight: 'bold', fontSize: 24, textAlign: 'center' }}>{user.fullName || 'No name'}</Text>
