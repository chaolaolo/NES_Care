    ...
    return (
        <KeyboardAvoidingView
            ...
            <ScrollView style={styles.container}>
                ...
                {/* <View>
                    {isLoading ?  */}
                        <View style={{width:'100%', height:'100%', backgroundColor: 'red', position: 'absolute' ,zIndex:5,justifyContent:'center',elevation:20,shadowColor:'black',shadowOpacity:10}} >
                            <ActivityIndicator size="large" color="#0000ff" style={{ backgroundColor: 'red' }} />
                        </View>
                     {/* : null}
                </View> */}
                {/* *** */}
