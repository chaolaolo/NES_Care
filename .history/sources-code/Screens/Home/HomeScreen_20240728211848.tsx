            ...
            <ScrollView style={{ marginBottom: 60 }}>
                ...
                <BlockComponent style={{}}>
                    ...
                    <View style={{ backgroundColor: 'white', width: '100%', height: 300, marginVertical: 10, justifyContent: 'center', alignItems: 'center' }}>
                        <Image source={imgBodyCondition! == null && imgBodyCondition! == '' ? { uri: imgBodyCondition } : require('../../image/ic_LeftinputUserName.png')} style={{ flex: 1, resizeMode: 'cover', width: 200, height: 200 }} />
                    </View>
                </BlockComponent>
            </ScrollView>
