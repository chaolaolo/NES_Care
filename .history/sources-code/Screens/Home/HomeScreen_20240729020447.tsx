...
const HomeScreen = () => {
    ...
    const [gratefulDate, setGratefulDate] = useState('Today');
                    ...
                    firestore()
                        ...
                        .then(snapshot => {
                            if (!snapshot.empty) {
                                ...
                                setGratefulDate(lastGrateful.data().date.toDate().toDateString());
                            } else {
                                setGratefulCount(0);
    ...
    }, [user.uid, gratefulCount,gratefulDate]);
            ...
            <ScrollView style={{ marginBottom: 60 }}>
                <View
                    ...
                    <BlockComponent
                        ...
                        <Text style={styles.contentItem}>Steps: {latestMove.steps}</Text>
                        <Text style={styles.contentItem}>Distances: {latestMove.distance} m</Text>
                    </BlockComponent>
                    <BlockComponent
                        ...
                        <Text style={styles.contentItem}>Count: {gratefulCount}</Text>
