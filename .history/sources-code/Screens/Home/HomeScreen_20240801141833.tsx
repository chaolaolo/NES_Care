        ...
        <SafeAreaView style={styles.container}>
            ...
            <ScrollView style={{ marginBottom: 60 }}>
                ...
                <BlockComponent style={{}}>
                    ...
                    <View style={{ backgroundColor: 'white', width: '100%', height: 2000, marginVertical: 10, justifyContent: 'center', alignItems: 'center' }}>
                        {imgBodyCondition !== null && imgBodyCondition !== '' ? (
                            <View>
                                <Image source={{ uri: imgBodyCondition }} style={{ width: 150, height: 150,backgroundColor:'red',resizeMode:'contain' }} />
                            </View>
                        ) : (
