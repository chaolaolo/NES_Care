                ...
                <View style={[styles.modalOverlay, { justifyContent: 'center' }]}>
                    <View style={[styles.modalContainer, { height: '26%', borderRadius: 20, marginHorizontal: 20 }]}>
                        ...
                        <View style={{ marginTop: 20, alignItems: 'center' }}>
                            <Text style={{ color: '#7B6BA8', fontSize: 16, fontWeight: 'bold' }}>Bạn có chắc chắn muốn xóa mục này không?</Text>
                        </View>
                        <View style={{ flexDirection: 'row', justifyContent: 'space-around', marginTop: 40, alignItems: 'center' }}>
                            <TouchableOpacity onPress={() => setshowDelete(false)} style={[styles.modalCancel, { flex: 1, alignItems: 'center', marginHorizontal: 10, borderWidth: 1, paddingHorizontal: 10, paddingVertical: 4, borderRadius: 10, borderColor: '#21CE9C',paddingVertical:16 }]}>
