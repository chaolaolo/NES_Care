...
//                         </View>
//                         <Text style={styles.contentItem}>Số bước: {latestMove.steps}/mục tiêu</Text>
//                         <Text style={styles.contentItem}>Quãng đường: {latestMove.distance}/mục tiêu (m)</Text>
//                     </BlockComponent>
//                     <BlockComponent
        ...
        const fetchTargetData = async () => {
            try {
                ...
                if (!targetSnapshot.empty) {
                    ...
                    setTargetSteps(targetData.steps);
                    setTargetDistance(targetData.distance);
                } else {
                    setTargetSteps(0);
                    setTargetDistance(0);
                }
            ...
            <ScrollView style={{ marginBottom: 60 }}>
                <View
                    ...
                    <BlockComponent
                        ...
                        <Text style={styles.contentItem}>Số bước: {latestMove.steps}/{targetSteps ? targetSteps : 'Chưa có mục tiêu'}</Text>
                        <Text style={styles.contentItem}>Quãng đường: {latestMove.distance}/{targetDistance ? targetDistance : 'Chưa có mục tiêu'} (m)</Text>
                    </BlockComponent>
                    <BlockComponent
                        onPress={() => navigation.navigate('WriteThanksScreen')}
                        style={{ flex: 1 }}>
