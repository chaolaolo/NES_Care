            ...
            <ScrollView style={{ marginBottom: 60 }}>
                <View
                    ...
                    <BlockComponent style={{ flex: 1 }}>
                        ...
                        <Text style={styles.contentItem}>Target 1: complete</Text>
                        <Text style={styles.contentItem}>Target 2: incomplete</Text>
                        <Text style={styles.contentItem}>Target 3: incomplete</Text>
