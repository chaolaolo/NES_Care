        ...
        const fetchTargetData = async () => {
            try {
                ...
                if (!targetSnapshot.empty) {
                    ...
                    setStepTarget(targetData.stepTarget);
            ...
            <ScrollView style={{ marginBottom: 60 }}>
                <View
                    ...
                    <BlockComponent
                        ...
                        <Text style={styles.contentItem}>Số bước: {latestMove.steps}/{stepTarget}m</Text>
                        <Text style={styles.contentItem}>Quãng đường: {latestMove.distance}/{stepTarget} (m)</Text>
                    </BlockComponent>
                    <BlockComponent
