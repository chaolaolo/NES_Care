...
const HomeScreen = () => {
    ...
    useEffect(() => {
        if (user.bmi < 18.5) {
            ...
            setImgBodyCondition('../../image/ic_LeftinputUserName.png')
        }
    }, [user.bmi])
            ...
            <ScrollView style={{ marginBottom: 60 }}>
                ...
                <BlockComponent style={{}}>
                    ...
                    <View style={{ backgroundColor: 'white', width: '100%', height: 300, marginVertical: 10, justifyContent: 'center', alignItems: 'center' }}>
                        <Image source={imgBodyCondition !== null ? { uri: imgBodyCondition } : require(imgBodyCondition)} style={{ flex: 1, resizeMode: 'cover', width: 200, height: 200 }} />
                    </View>
                </BlockComponent>
            </ScrollView>
