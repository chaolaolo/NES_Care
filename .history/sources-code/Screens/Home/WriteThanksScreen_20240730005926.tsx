            ...
            >
                <View style={[styles.modalOverlay, { justifyContent: 'center' }]}>
                    <View style={[styles.modalContainer, { height: '26%', borderRadius: 20, marginHorizontal: 20 }]}>
                        ...
                        <View style={{ flexDirection: 'row', justifyContent: 'space-around', marginTop: 40, alignItems: 'center' }}>
                            <TouchableOpacity onPress={() => setshowDelete(false)} style={[styles.modalCancel, { flex: 1, alignItems: 'center', marginHorizontal: 10,marginBottom:40, borderWidth: 1, paddingHorizontal: 10, paddingVertical: 16, borderRadius: 10, borderColor: '#21CE9C', }]}>
