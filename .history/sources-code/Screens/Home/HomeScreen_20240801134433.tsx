...
const HomeScreen = () => {
    ...
    useEffect(() => {
        if (user.bmi < 18.5) {
            ...
            setImgBodyCondition('https://i.pinimg.com/736x/20/ba/5c/20ba5cd79791218da5193675c41bf07f.jpg');
                ...
                <BlockComponent style={{}}>
                    ...
                    <View style={{ backgroundColor: 'white', width: '100%', height: 300, marginVertical: 10, justifyContent: 'center', alignItems: 'center' }}>
                        {imgBodyCondition !== null && imgBodyCondition !== '' ? (
                            <View>
                                <Image source={{ uri: imgBodyCondition }} style={{ flex: 1, resizeMode: 'center', width: 200, height: 200 }} />
                            </View>
                        ) : (
