...
const ForgotPassScreen = () => {
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <View>
                <Text style={{ marginHorizontal: 18, marginVertical: 10, fontSize: 20, color: 'black' }}>
                    Hãy nhập email mà bạn đã đăng ký trên ứng dụng của chún tôi để có thể thiết lập mật khẩu mới nhé.
                </Text>
