...
function CustomDrawerContent(props: any) {
  ...
  return (
    <DrawerContentScrollView {...props}>
      ...
      <TouchableOpacity style={{ flexDirection: 'row', borderWidth: 2,borderColor:'#21CE9C',borderRadius:10, paddingVertical: 16, alignItems: 'center', justifyContent: 'space-around',marginHorizontal:40,}}>
        <Text>Sign Out</Text>
