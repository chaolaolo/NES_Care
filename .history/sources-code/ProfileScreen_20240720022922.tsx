        ...
        <SafeAreaView style={styles.container}>
            <View style={styles.header}>
                ...
                <View style={{ marginHorizontal: 10, flex: 1 }}>
                    <Text style={{ color: '#432C81', fontWeight: 'bold', fontSize: 24 }}>{user.fullName}</Text>
                    <Text style={{ color: '#7B6BA8', fontSize: 16 }}>{user.email||''}</Text>
                </View>
            ...
            <BlockComponent style={{ marginTop: 40 }}>
                ...
                <View style={{ marginLeft: 10, marginVertical: 2 }}>
                    <Text>Gender</Text>
                    <Text style={styles.mainText}>{user.gender || ''}</Text>
                </View>
                <View style={{ marginLeft: 10, marginVertical: 2 }}>
                    <Text>Height</Text>
                    <Text style={styles.mainText}>{user.height || ''}</Text>
                </View>
                <View style={{ marginLeft: 10, marginVertical: 2 }}>
                    <Text>Weight</Text>
                    <Text style={styles.mainText}>{user.weight || ''}</Text>
                </View>
                <View style={{ marginLeft: 10, marginVertical: 2 }}>
                    <Text>BMI</Text>
                    <Text style={styles.mainText}>{user.bmi || ''}</Text>
                </View>
