...
const SignInScreen = () => {
    ...
    const handleSignIn = () => {
        ...
        if (password.length === 0) {
            setErrEmail('Please enter your password!')
            err = true;
        } else if (password.length < 6) {
            setErrEmail('Please enter more than 6 character!')
            err = true;
        } else {
            setErrEmail('')
        }
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            {errEmail?<Text>{errEmail}</Text>:null}
            <View>
                <TextInputComponent
                    value={password}
            ...
            {errPassword?<Text>{errPassword}</Text>:null}
