...
const ProfileScreen = () => {
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <Pressable onPress={() => navigation.navigate('CalculateBMIScreen')} style={{ flexDirection: 'row',marginHorizontal:'22%',marginTop:'-3.4%', }}>
                    <Text style={{ color: 'black', fontSize: 18,textDecorationLine:'line-through' }} >Caculate BMI</Text>
                </Pressable>
