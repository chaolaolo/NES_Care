    ...
    return (
        <SafeAreaView style={styles.container}>
            <View style={styles.header}>
                <TouchableOpacity>
                    <Image style={styles.imgAvatar} source={{ uri: user.avatar ? user.avatar : require('./image/ic_LeftinputUserName.png') }} />
            ...
            <BlockComponent style={{ marginTop: 40 }}>
                <View style={{ marginLeft: 10, marginVertical: 2 }}>
                    <Text>Full name</Text>
                    <Text style={styles.mainText}>{user.fullName || 'No name'}</Text>
                </View>
                <View style={{ marginLeft: 10, marginVertical: 2 }}>
                    <Text>Gender</Text>
