        ...
        if (!err) {
            auth()
                ...
                .then(async (userCredential) => {
                    ...
                    const userData = userDoc.exists ? userDoc.data() : { fullName: 'null', email: 'null', gender: 'null', height: 'null', weight: 'null', bmi: 'null',avatar: 'null' };
