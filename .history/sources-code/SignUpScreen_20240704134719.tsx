    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <View style={{flexDirection:'row',paddingHorizontal:10,flexWrap:'wrap'}}>
                ...
                <Text style={{fontSize:20,color:'blue'}} > Terms of Service</Text>
                <Text style={{fontSize:20,color:'blue'}} >and</Text>
                <Text style={{fontSize:20,color:'blue'}} >Privacy Policy</Text>
            </View>
