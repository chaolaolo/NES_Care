...
const SignUpScreen = () => {
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <View style={{ marginBottom: errFullName ? 0 : 20 }}>
                <TextInputComponent
                    value={fullName}
            ...
            <View style={{ marginBottom: errEmail ? 0 : 20 }}>
                <TextInputComponent
                    value={email}
            ...
            <View style={{ marginBottom: errPassword ? 0 : 18 }}>
                <TextInputComponent
                    value={password}
            ...
            <View style={{ marginBottom: errRePassword ? 0 : 20 }}>
                <TextInputComponent
                    value={rePassword}
