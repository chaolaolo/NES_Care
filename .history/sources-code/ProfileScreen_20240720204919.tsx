    ...
    return (
        <SafeAreaView style={styles.container}>
            <View style={styles.header}>
                ...
                <View style={{ marginHorizontal: 10, flex: 1, backgroundColor: '#21CE9C', flexDirection: 'row' }}>
                    <View>
                    ...
                    <TouchableOpacity onPress={chooseAvatar} style={{ backgroundColor: 'red', height: 30,marginHorizontal:10 }}>
                        <Image style={{ width: 26, height: 26 }} source={require('./image/ic_pen.png')} />
                    </TouchableOpacity>
                </View>
