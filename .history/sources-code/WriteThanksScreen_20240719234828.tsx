        ...
        <SafeAreaView style={styles.container}>
            ...
            >
                <View style={[styles.modalOverlay, { justifyContent: 'center' }]}>
                    <View style={[styles.modalContainer, { height: '40%', borderRadius: 20, marginHorizontal: 20 }]}>
                        <Text style={[styles.modalTitle, { alignSelf: 'center', marginBottom: 40 }]}>Edit Grateful</Text>
                        <View style={{ marginTop: 20, }}>
                            <Text style={{ color: 'black', fontSize: 16, fontWeight: 'bold', marginHorizontal: 20 }}>Content</Text>
                            <TextInput
                                autoFocus={true}
                                value={grateful}
                                onChangeText={setGrateful}
