...
const ProfileScreen = () => {
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <Pressable onPress={() => navigation.navigate('CalculateBMIScreen')} style={{ flexDirection: 'row', alignItems: 'center',backgroundColor:'red' }}>
                    <Text style={{ color: 'black', fontSize: 18,textAlign:'center' }}>Caculate BMI</Text>
                </Pressable>
