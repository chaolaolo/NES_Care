  ...
  return (
    <NavigationContainer>
      <Drawer.Navigator initialRouteName='SplashScreen' screenOptions={{ headerShown: false }}>
        ...
        <Drawer.Screen name='HomeTab' component={BottomTabs} />
        {/* <Drawer.Screen name='HomeDrawer' component={DrawerNavigation} /> */}
        <Drawer.Screen name='Statistics' component={HomeScreen} />
        <Drawer.Screen name='Notifications' component={HomeScreen} />
        <Drawer.Screen name='Settings' component={ProfileScreen} />
        <Drawer.Screen name='ChoiceSignScreen' component={ChoiceSignScreen} />
        <Drawer.Screen name='SignInScreen' component={SignInScreen} />
        <Drawer.Screen name='SignUpScreen' component={SignUpScreen} />
        <Drawer.Screen name='ForgotPassScreen' component={ForgotPassScreen} />
        <Drawer.Screen name='WriteThanksScreen' component={WriteThanksScreen} />
