            ...
            <View style={styles.modalOverlay}>
                <View style={styles.modalContainer} >
                    ...
                    <View style={{ flexDirection: 'row', width: '100%', justifyContent: 'space-evenly' }}>
                        <ButtonComponent title="Cancel" onPress={props.onClose} style={{ backgroundColor: 'white', borderWidth: 2, borderColor: '#FD7278', flex: 1 }} btnTitleStyle={{color:'#FD7278'}}/>
                        <ButtonComponent title="Save" onPress={props.btnSavePress} style={{ flex: 1 }} />
                    </View>
                </View>
            </View>
        </Modal>
