            ...
            <View style={styles.modalOverlay}>
                <View style={styles.modalContainer} >
                    ...
                    <View style={{ flexDirection: 'row', width: '100%', justifyContent: 'space-evenly' }}>
                        <ButtonComponent title={["Hủy", props.cancelTitle]} onPress={props.onClose} style={{ backgroundColor: 'white', borderWidth: 2, borderColor: '#FD7278', flex: 1 }} btnTitleStyle={{ color: '#FD7278' }} />
