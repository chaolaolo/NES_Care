            ...
            <View style={styles.modalOverlay}>
                <View style={styles.modalContainer}>
                    ...
                    <View style={styles.boxText}>
                        ...
                        <Text style={{textAlign:'center',width:'90%'}}>Lorem ipsum dolor sit amet consectetur adipisicing elit. Officia dignissimos optio, repellat nulla distinctio maxime quis quidem, perferendis autem temporibus reprehenderit assumenda ex similique sed consequatur vero voluptates, facere at!</Text>
                    </View>
                </View>
            </View>
        </Modal>
